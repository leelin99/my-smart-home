<template>
  <view class="forget">
    <uni-popup ref="popup" type="center">
      <view class="content" style="padding: 20px;background-color:white">
        <view style="text-align:left;padding:5px" @tap="close">✖</view>
        <!-- 主体 -->
        <view class="main">
          <view class="tips">若你忘记了密码或者想要修改密码，可在此重置新密码。</view>
        ...
        <wButton text="重置密码" :rotate="isRotate" @click.native="startRePass()" style="color:#FF6666"></wButton>
      </view>
    </uni-popup>
  </view>
</template>
